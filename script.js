...
function setContent() {
  ...
  style.textContent = '.ctf-card{display:flex!important;flex-direction:column!important;min-height:260px!important}.ctf-card .ctf-name{font-size:1.12rem!important;line-height:1.3!important;letter-spacing:-.01em!important}.ctf-card .ctf-meta{display:inline-flex!important;align-items:center!important;width:max-content!important;font-family:var(--mono)!important;font-size:10px!important;line-height:1.3!important;letter-spacing:.06em!important;text-transform:uppercase!important;color:var(--text-low)!important;font-weight:500!important;margin:5px 0 16px!important;padding:4px 7px!important;border:1px solid rgba(113,135,151,.22)!important;border-radius:2px!important;background:rgba(255,255,255,.015)!important}.ctf-card .ctf-meta::before,.ctf-card .ctf-meta::after{display:none!important}.ctf-card p{font-size:.92rem!important;line-height:1.7!important;color:var(--text)!important;margin:0 0 18px!important;max-width:34ch!important;position:relative!important;padding-left:14px!important;border-left:2px solid rgba(76,255,154,.28)!important}.ctf-card a{display:inline-flex!important;align-items:center!important;gap:6px!important;width:max-content!important;margin-top:auto!important;padding-top:8px!important;border-top:1px solid rgba(113,135,151,.16)!important;color:var(--text-low)!important;font-family:var(--mono)!important;font-size:11px!important;line-height:1.4!important;letter-spacing:.04em!important;text-decoration:none!important;transition:color .2s ease,border-color .2s ease,transform .2s ease!important}.ctf-card a:hover{color:var(--green)!important;border-color:rgba(76,255,154,.42)!important;transform:translateX(3px)!important}.ctf-card.panel:hover{border-color:rgba(76,255,154,.45)!important}.nav-links{margin-left:24px!important}.interest-card .icon{width:32px;height:32px}';
